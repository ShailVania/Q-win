...
import { microsoftProvider } from "../../../../hey/qwin/src/config/IntialiseFirebase"
...
import Loading from "../../../../hey/qwin/src/config/Loding"
import { isLoading, LOCAL_STORAGE } from "../../../../hey/qwin/src/config/localStorage"
...
export default function Login() {
  ...
  return (
    <div className="home">
      ...
      <div className="logo">
        <img src={require("../../../../hey/qwin/src/assets/logo.png")} alt="University of Windsor" />
      </div>
